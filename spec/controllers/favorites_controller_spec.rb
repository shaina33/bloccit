...
RSpec.describe FavoritesController, type: :controller do
    ...
    context 'signed in user' do
        ...
        describe 'POST create' do
            ...
            #below test fails due to auto-favorite at post creation
            ...
            # end
            it 'creates a favorite for the current user & specified post' do
                expect(another_user.favorites.find_by_post_id(my_post.id)).to be_nil
                another_user.favorites.create(post: my_post)
